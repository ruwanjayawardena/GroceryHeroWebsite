            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-users"></i> Errand Requester  &nbsp;&nbsp;<a class="btn btn-primary d-print-none" onclick="navigateDashboard();"><i class="fas fa-arrow-circle-left"></i>&nbsp;Back</a></h4>                       
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-5 col-sm-6">
                        <form id="userform" novalidate>
                            ...
                            <input type="hidden" class="form-control cmb_usercategory" value="4">
                            <div class="form-row">                                
                                <div class="col">
			...
			$.post('controllers/userController.php', {action: 'userTableByCatID', usr_cat_id: usr_cat_id}, function (e) {
				if (e === undefined || e.length === 0 || e === null) {
					...
					$.each(e, function (index, qdt) {
						...
						tbldata += '</td>';
						tbldata += '<td></td>';
						tbldata += '<td>' + qdt.usr_first_name + '</td>';
