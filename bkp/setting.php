                        ...
                        <div class="row">
                            <div class="col-lg-2 col-sm-4">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
									...
									<a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-slider" role="tab" aria-controls="v-pills-slider" aria-selected="false">Slider</a>
									<a class="nav-link" id="v-pills-sec2-tab" data-toggle="pill" href="#v-pills-sec2" role="tab" aria-controls="v-pills-sec2" aria-selected="false">Home Page Welcome Message</a>
                                </div>
                            </div>
                            <div class="col-lg-10 col-sm-8">
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-logo" role="tabpanel" aria-labelledby="v-pills-logo-tab">
                                        <h4 class="mb-4"><i class="fas fa-clipboard-list"></i> Website Logo</h4>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-smedia" role="tabpanel" aria-labelledby="v-pills-smedia-tab">
                                        <h4 class="mb-4"><i class="fas fa-clipboard-list"></i> Social Media Links</h4>
                                        <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-slider" role="tabpanel" aria-labelledby="v-pills-slider-tab">
                                        ...
                                        <div class="form-row">
                                            <div class="col-7">
                                                <div class="form-group">
                                                    <label for="sys_slider_text1">First Heading</label>
                                                    <input type="text" class="form-control" id="sys_slider_text1" placeholder="Big Text Heading">
                                                </div>
                                                <div class="form-group">
                                                    <label for="sys_slider_text2">Second Heading</label>
                                            ...
                                            <div class="col-5">
                                                <iframe  id="iframe_slider" scrolling="no"></iframe>
                                            </div>
                                        </div>
                                    </div>
